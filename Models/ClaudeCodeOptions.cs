...
public sealed class ClaudeCodeOptions
{
    ...
    public string WorkspaceMode { get; init; } = "local";

    public string? ServerWorkspaceRoot { get; init; }

    public string? WorkspaceDataPath { get; init; }

    public string? ManagedWorkspaceRoot { get; init; }

    public string[] AllowedGitRepositoryHosts { get; init; } = [];
